    ...
    <div className='border-t-2 pt-2 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='mt-20'>
         ...
         <div className='flex flex-col gap-4 px-6 py-6 text-sm text-gray-500'>
            <p>Indulge in superior craftsmanship and timeless design. This product is made using premium materials to deliver unmatched quality, elegance, and long-lasting performance.</p>
            <p>Built for everyday use with a focus on comfort and durability. A must-have essential that combines quality with modern design.</p>
         </div>
      </div>
